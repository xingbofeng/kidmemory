...
try {
    api.datasetControllerDeleteAssetsBatch();
} on DioException catch (e) {
    print('Exception when calling DatasetApi->datasetControllerDeleteAssetsBatch: $e\n');
}
```
...
> datasetControllerDeleteChild(id)
...
try {
    ...
    print('Exception when calling DatasetApi->datasetControllerDeleteChild: $e\n');
}
```
...
> datasetControllerUpdateAssetPatch(id)
...
try {
    ...
    print('Exception when calling DatasetApi->datasetControllerUpdateAssetPatch: $e\n');
}
```
...
> datasetControllerUpdateChild(id)
...
try {
    ...
    print('Exception when calling DatasetApi->datasetControllerUpdateChild: $e\n');
}
```
