...
class AgentConfigApi {
  ...
  Future<Response<void>> agentConfigControllerCreateConfig({
    ...
    final _path = r'/api/config/agent-configs';
  ...
  Future<Response<void>> agentConfigControllerDeleteConfig({
    ...
    final _path = r'/api/config/agent-configs/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> agentConfigControllerGetDefaultConfig({
    ...
    final _path = r'/api/config/agent-configs/default';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> agentConfigControllerSetDefaultConfig({
    ...
    final _path = r'/api/config/agent-configs/{id}/set-default'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> agentConfigControllerTestConfig({
    ...
    final _path = r'/api/config/agent-configs/{id}/test'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
