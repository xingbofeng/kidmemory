...
class DatasetApi {
  ...
  Future<Response<void>> datasetControllerAddSearchCandidatePoolItems({ 
    ...
    final _path = r'/search/candidate-pool/items';
  ...
  Future<Response<void>> datasetControllerDeleteAsset({ 
    ...
    final _path = r'/assets/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> datasetControllerGetAssetPreview({ 
    ...
    final _path = r'/assets/{id}/preview'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> datasetControllerGetChild({ 
    ...
    final _path = r'/children/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> datasetControllerGetExportArtifactShareMetadata({ 
    ...
    final _path = r'/storage/export-artifacts/{id}/share'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> datasetControllerGetSearchIndexingStatus({ 
    ...
    final _path = r'/search/indexing-status';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> datasetControllerListSearchCandidatePool({ 
    ...
    final _path = r'/search/candidate-pool';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> datasetControllerRemoveSearchCandidatePoolItemsPost({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/search/candidate-pool/items/remove';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> datasetControllerRunSearchIndexer({ 
    ...
    final _path = r'/search/indexing/run';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> datasetControllerRunStorageSync({ 
    ...
    final _path = r'/storage/sync/run';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> datasetControllerSyncAssetToStorage({ 
    ...
    final _path = r'/storage/assets/{id}/sync'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> datasetControllerSyncExportArtifactToStorage({ 
    ...
    final _path = r'/storage/export-artifacts/{id}/sync'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> datasetControllerUpdateAsset({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/assets/{id}/update'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
