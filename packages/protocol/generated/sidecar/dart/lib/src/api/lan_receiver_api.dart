...
class LanReceiverApi {
  ...
  Future<Response<void>> lanReceiverControllerDiscover({ 
    ...
    final _path = r'/api/web-companion/lan/discover';
  ...
  Future<Response<void>> lanReceiverControllerDiscoverDevices({ 
    ...
    final _path = r'/api/web-companion/lan/devices';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> lanReceiverControllerGetSessionStatus({ 
    ...
    final _path = r'/api/web-companion/lan/sessions/{sessionId}/status'.replaceAll('{' r'sessionId' '}', sessionId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> lanReceiverControllerPair({ 
    ...
    final _path = r'/api/web-companion/lan/pair';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> lanReceiverControllerUpload({ 
    ...
    final _path = r'/api/web-companion/lan/sessions/{sessionId}/upload'.replaceAll('{' r'sessionId' '}', sessionId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
