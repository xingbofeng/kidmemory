...
const copy = {
  zh: {
    ...
    v1Title: "Curated, not piled up",
    v1Desc: "孩子的画作、照片、手工和早期表达不应该只堆在相册里。它们需要被重新挑选、排序、连接成故事。",
    v2Title: "AI as an editor",
    v2Desc: "Agent 像编辑助理一样整理素材、生成结构、修复输出，但家庭的判断和叙事权始终留在用户手里。",
    v3Title: "Private by design",
    v3Desc: "开源版从 macOS 桌面、本地文件、PostgreSQL + pgvector 和隔离 workspace 开始，把隐私和可迁移放在底层。",
  ...
  en: {
    ...
    v1Title: "Curated, not piled up",
    v1Desc: "Children's artwork, photos, crafts, and early expressions should not just pile up in an album. They deserve selection, sequence, and story.",
    v2Title: "AI as an editor",
    v2Desc: "Agents behave like editorial assistants: organizing material, generating structure, and repairing output while the family keeps judgment and narrative control.",
    v3Title: "Private by design",
    v3Desc: "The open-source edition starts with macOS desktop, local files, PostgreSQL + pgvector, and isolated workspaces so privacy and portability sit at the foundation.",
