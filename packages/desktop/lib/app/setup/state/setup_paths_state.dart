...
extension _DesktopShellSetupPathsState on _DesktopShellState {
  ...
  _KidMemoryPathSet _pathsFromConfig(
    ...
    return (
      dataDir: _stringOrDefault(config.dataDir, fallback.dataDir),
      workspaceDir: _stringOrDefault(config.workspaceDir, fallback.workspaceDir),
      exportDir: _stringOrDefault(config.exportDir, fallback.exportDir),
    );
  }
}
