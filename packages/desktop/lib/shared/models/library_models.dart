...
// 从其他文件导入的类型
export '../../features/setup/setup_page.dart' show SetupCheckVm, SupabaseStorageVm;
export '../../features/generate_export/generate_export_page.dart' show ExportResultVm;
export '../../data/sample_assets.dart' show SampleAssetVm;

class ChildVm {
  const ChildVm({required this.id, required this.name});
