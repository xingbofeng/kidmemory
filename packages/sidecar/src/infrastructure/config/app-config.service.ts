...
export function loadConfigFromEnv(
  ...
  return {
    ...
    claude: {
      apiKey: env.CLAUDE_API_KEY || env.OPENAI_API_KEY || "",
    ...
    supabaseStorage: {
      ...
      bucket: env.SUPABASE_STORAGE_BUCKET || env.SUPABASE_S3_BUCKET || "",
      serviceRoleKey: env.SUPABASE_SERVICE_ROLE_KEY || "",
      anonKey: env.SUPABASE_ANON_KEY || "",
      publicBaseUrl: env.SUPABASE_STORAGE_PUBLIC_BASE_URL || "",
      ...
      s3: {
        endpoint:
          ...
          || defaultSupabaseS3Endpoint(env.SUPABASE_URL || ""),
        region:
          env.SUPABASE_S3_REGION
          || env.SUPABASE_STORAGE_REGION
          || env.SUPABASE_STORAGE_S3_REGION
          || "auto",
        accessKeyId:
          env.SUPABASE_S3_ACCESS_KEY_ID
          || env.SUPABASE_STORAGE_S3_ACCESS_KEY_ID
          || "",
        secretAccessKey:
          env.SUPABASE_S3_SECRET_ACCESS_KEY
          || env.SUPABASE_STORAGE_S3_SECRET_ACCESS_KEY
          || "",
      },
    },
    webCompanionDirectUpload: {
    ...
    paths: {
      workspaceDir:
        env.KIDMEMORY_WORKSPACE_DIR || path.join(pathRoot, "workspace"),
      exportDir: env.KIDMEMORY_EXPORT_DIR || path.join(pathRoot, "exports"),
      dataDir: env.KIDMEMORY_DATA_DIR || path.join(pathRoot, "data"),
    },
    sidecar: {
