...
class MockAgent {
  ...
  static create = (config: any) => new MockAgent(config);
  static DEFAULT_MODEL_PLACEHOLDER = 'gpt-4';
...
const mockDependencies = {
  Agent: MockAgent as any as typeof import('@openai/agents').Agent,
  run: (agent: any, input: any, options?: any) => mockRunBehavior(agent, input, options)
} as any;
