...
import type { TestConfigRequest, TestConfigResult } from '../domain/agent-config-domain.service.ts';
import type {
...
export class AgentConfigApplicationService {
   ...
   */
  async testConfig(request: TestConfigRequest): Promise<TestConfigResult> {
    // Validate request
