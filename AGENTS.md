...
- Hermes + Harness + Codex 的 Issue 驱动流程记录在 `docs/agent-workflow/workflow.md`。
- GitHub Issue 内容提纲记录在 `docs/agent-workflow/issue-template.md`。
- `AGENTS.md` 只保留执行约定；状态机、Issue 模板和长流程说明优先维护在 `docs/agent-workflow/`。
